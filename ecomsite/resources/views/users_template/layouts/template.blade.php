...
<body>
    ...
    <div class="banner_bg_main">
                    ...
                    <div class="col-sm-12">
                        <div class="custom_menu">
                            <ul>
                                ...
                                <li><a href="{{ route('newrealese') }}">New Releases</a></li>
        ...
        <div class="logo_section">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="logo"><a href="/"><b style="font-size: 27px;color: white;">EcomSite</b></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="containt_main">
                    ...
                    <span class="toggle_icon" onclick="openNav()"><img
                            src="{{ asset('users/images/toggle-icon.png') }}"></span>
                    <div class="dropdown">
                    ...
                    <div class="header_box">
                        <div class="lang_box ">
                            <a href="#" title="Language" class="nav-link" data-toggle="dropdown"
                                aria-expanded="true">
                                <img src="{{ asset('users/images/flag-uk.png') }}" alt="flag" class="mr-2 "
                                    title="United Kingdom">
                                English <i class="fa fa-angle-down ml-2" aria-hidden="true"></i>
                            </a>
                            <div class="dropdown-menu ">
                                <a href="#" class="dropdown-item">
                                    <img src="{{ asset('users/images/flag-france.png') }}" class="mr-2"
                                        alt="flag">
                                    French
                                </a>
                            </div>
    ...
    <div class="footer_section layout_padding">
        <div class="container">
            ...
            <div class="location_main">Help Line Number : <a href="#">+880 1723 985 137</a></div>
        </div>
    </div>
    <!-- footer section end -->
