...
@section('page-title')
    Edit Product Image | EcomSite
@endsection
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page/</span> Edit Product Image </h5>
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('storeproduct') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img class="img img-rounded" src="{{ asset($productinfo->product_img) }}" alt=""@style('width:80%')>
                            </div>
                        </div>
                        <div class="row mb-3">
