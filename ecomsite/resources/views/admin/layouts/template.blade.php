@php
    ...
    $userphoto = Illuminate\Support\Facades\Auth::user()->userphoto;
@endphp
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('admindashboard') }}" class="app-brand-link">
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">EcomSite</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('completeorder') }}" class="menu-link">
                            ...
                            <div data-i18n="Analytics">Complete Order</div>
                        </a>
                    </li>
                    <li class="menu-item">
