                            ...
                            <form action="#" method="post" id="profile_form">
                                ...
                                <div class="row">
                                    <div class="col-lg">
                                        ...
                                        <input type="text" name="empid" id="empid" class="form-control rounded-0" value="{{ $userInfo->empid }}">
                                    </div>
                                    <div class="col-lg">
                                        <label for="usertype">User Type</label>
                                        <select name="usertype" id="usertype" class="form-select rounded-0">
                                            <option value="" selected disabled>-Select-</option>
                                            <option value="1" {{ $userInfo->usertype == '1' ? 'selected' : '' }}>Admin</option>
                                            <option value="2" {{ $userInfo->usertype == '2' ? 'selected' : '' }}>Manager</option>
                                            <option value="3" {{ $userInfo->usertype == '3' ? 'selected' : '' }}>IT</option>
                                            <option value="4" {{ $userInfo->usertype == '4' ? 'selected' : '' }}>Employee</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="my-2">
