...
@section('content')
    <section id="works" class="works">
        <div class="container">
            <x-section-header class="" sectionTitle="how it works"
                sectionSubTitle="Learn More about how our website works" /><!--/.section-header-->
            <!--/.section-header-->
    ...
    <section id="explore" class="explore">
        <div class="container">
            <x-section-header class="" sectionTitle="explore"
                sectionSubTitle="Explore New place, food, culture around the world and many more" /><!--/.section-header-->
            <div class="explore-content">
                <div class="row">
                    <div class=" col-md-4 col-sm-6">
                        <div class="single-explore-item">
                            <div class="single-explore-img">
                                <img src="{{ asset('home/assets/images/explore/e1.jpg') }}" alt="explore image">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <div class="explore-person-img">
                                                <a href="#">
                                                    <img src="{{ asset('home/assets/images/explore/person.png') }}"
                                                        alt="explore person">
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="single-explore-item">
                            <div class="single-explore-img">
                                <img src="{{ asset('home/assets/images/explore/e2.jpg') }}" alt="explore image">
                                <div class="single-explore-img-info">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="single-explore-item">
                            <div class="single-explore-img">
                                <img src="{{ asset('home/assets/images/explore/e3.jpg') }}" alt="explore image">
                                <div class="single-explore-img-info">
                                    <button onclick="window.location.href='#'">best rated</button>
                                    <div class="single-explore-image-icon-box">
                                        <ul>
                    ...
                    <div class=" col-md-4 col-sm-6">
                        <div class="single-explore-item">
                            <div class="single-explore-img">
                                <img src="{{ asset('home/assets/images/explore/e4.jpg') }}" alt="explore image">
                                <div class="single-explore-img-info">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="single-explore-item">
                            <div class="single-explore-img">
                                <img src="{{ asset('home/assets/images/explore/e5.jpg') }}" alt="explore image">
                                <div class="single-explore-img-info">
                                    <button onclick="window.location.href='#'">featured</button>
                                    <div class="single-explore-image-icon-box">
                                        <ul>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="single-explore-item">
                            <div class="single-explore-img">
                                <img src="{{ asset('home/assets/images/explore/e6.jpg') }}" alt="explore image">
                                <div class="single-explore-img-info">
                                    <button onclick="window.location.href='#'">best rated</button>
                                    <div class="single-explore-image-icon-box">
                                        <ul>
    ...
    <section id="reviews" class="reviews">
        <div class="section-header">
            <x-section-header class="" sectionTitle="clients reviews"
                sectionSubTitle="What our client say about us" /><!--/.section-header-->
                ...
                <div class="testimonial-carousel">
                        ...
                        <div class="testimonial-description">
                            <div class="testimonial-info">
                                <div class="testimonial-img">
                                    <img src="{{ asset('home/assets/images/clients/c1.png') }}" alt="clients">
                                </div><!--/.testimonial-img-->
                    ...
                    <div class="single-testimonial-box">
                        <div class="testimonial-description">
                            <div class="testimonial-info">
                                <div class="testimonial-img">
                                    <img src="{{ asset('home/assets/images/clients/c2.png') }}" alt="clients">
                                </div><!--/.testimonial-img-->
                                <div class="testimonial-person">
                                    <h2>monirul islam</h2>
                                    <h4>london, UK</h4>
                    ...
                    <div class="single-testimonial-box">
                        <div class="testimonial-description">
                            <div class="testimonial-info">
                                <div class="testimonial-img">
                                    <img src="{{ asset('home/assets/images/clients/c3.png') }}" alt="clients">
                                </div><!--/.testimonial-img-->
                                <div class="testimonial-person">
                    ...
                    <div class="single-testimonial-box">
                        <div class="testimonial-description">
                            <div class="testimonial-info">
                                <div class="testimonial-img">
                                    <img src="{{ asset('home/assets/images/clients/c4.png') }}" alt="clients">
                                </div><!--/.testimonial-img-->
                                <div class="testimonial-person">
                                    <h2>Tom Leakar</h2>
                                    <h4>london, UK</h4>
    ...
    <section id="blog" class="blog">
        <div class="container">
            <div class="section-header">
                <x-section-header class="" sectionTitle="news and articles"
                    sectionSubTitle="Always upto date with our latest News and Articles" /><!--/.section-header-->
                <div class="blog-content">
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="single-blog-item">
                                <div class="single-blog-item-img">
                                    <img src="{{ asset('home/assets/images/blog/b1.jpg') }}" alt="blog image">
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-blog-item">
                                <div class="single-blog-item-img">
                                    <img src="{{ asset('home/assets/images/blog/b2.jpg') }}" alt="blog image">
                                </div>
                                <div class="single-blog-item-txt">
                                    <h2><a href="#">How to find your Desired Place more quickly</a></h2>
                                    <h4>posted <span>by</span> <a href="#">admin</a> march 2018</h4>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-blog-item">
                                <div class="single-blog-item-img">
                                    <img src="{{ asset('home/assets/images/blog/b3.jpg') }}" alt="blog image">
                                </div>
                                <div class="single-blog-item-txt">
                                    <h2><a href="#">How to find your Desired Place more quickly</a></h2>
                                    <h4>posted <span>by</span> <a href="#">admin</a> march 2018</h4>
